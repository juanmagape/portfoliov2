    ...
    return (
        <div className="documentation-container">
            ...
            <section id="setup" className="doc-section">
                ...
                <img src="/azure-project/Screenshot 2026-07-31 205431.png" alt="Hyper-V Manager with winserv2025" />
            </section>
            ...
            <section id="configuration" className="doc-section">
                ...
                <img src="/azure-project/Screenshot 2026-07-31 232639.png" alt="Server Manager Dashboard" />
            </section>
            ...
            <section id="structure" className="doc-section">
                ...
                <img src="/azure-project/Screenshot 2026-08-02 194935.png" alt="Organizational Units Structure" />
            </section>
            ...
            <section id="automation" className="doc-section">
                ...
                <img src="/azure-project/Screenshot 2026-08-12 232425.png" alt="CSV file with user data" />
                <img src="/azure-project/Screenshot 2026-08-12 232430.png" alt="PowerShell script for user creation" />
                <ul>
                ...
                <img src="/azure-project/Screenshot 2026-08-12 232351.jpg" alt="User creation log" />
                <img src="/azure-project/Screenshot 2026-08-12 232512.png" alt="Users created in Active Directory" />
            </section>
            ...
            <section id="hybrid-environment" className="doc-section">
                ...
                <img src="/azure-project/pendblur-sufijo.png" alt="Alternative UPN suffix configuration" />
                <ul>
                ...
                <img src="/azure-project/Screenshot 2026-08-12 233706.png" alt="Provisioning Agent Installation" />
                <img src="/azure-project/Screenshot 2026-08-12 233814.png" alt="Connection to Microsoft Entra ID" />
            </section>
            ...
            <section id="synchronization" className="doc-section">
                ...
                <img src="/azure-project/Screenshot 2026-08-12 233903.png" alt="Azure Portal to download agent" />
                <ul>
                ...
                <img src="/azure-project/Screenshot 2026-08-12 235722.png" alt="Agent connection to local Active Directory" />
                <ul>
                ...
                <img src="/azure-project/Screenshot 2026-08-13 000555.png" alt="Enable password hash synchronization" />
                <ul>
                ...
                <img src="/azure-project/Screenshot 2026-08-13 001544.png" alt="Synchronized users in Entra ID" />
            </section>
            ...
            <section id="iaas-bastion" className="doc-section">
                ...
                <img src="/azure-project/Screenshot 2026-08-13 035320.png" alt="Connection to Bastion in Azure" />
                <ul>
                ...
                <img src="/azure-project/Screenshot 2026-08-13 035403.jpg" alt="Secure SSH terminal in browser" />
            </section>
        </div>
    );
}
